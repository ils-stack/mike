<div id="dtatblCurrBudget" data-mdb-pagination="false">
</div>
...
function resetCBudgetLst(){
  $("#dtatblCurrBudget").html("");
}


function currBudgetLst(){
  ...
  const asyncTable = new mdb.Datatable(
    document.getElementById('dtatblCurrBudget'),
    { columns, },
    { loading: true }
  );
  ...
  fetch('{{ route('getIncomeHeads.get') }}')
  ...
  // const instance = new mdb.Datatable(document.getElementById('dtatblCurrBudget'), ajxData)
  //
