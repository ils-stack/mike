<div id="dtatblDisBudget" data-mdb-pagination="false">
</div>
...
function resetDBudgetLst(){
  $("#dtatblDisBudget").html("");
}


function disBudgetLst(){
  ...
  const asyncTable = new mdb.Datatable(
    document.getElementById('dtatblDisBudget'),
    { columns, },
    { loading: true }
  );
  ...
  fetch('{{ route('getIncomeHeadsDis.get') }}')
  ...
  // const instance = new mdb.Datatable(document.getElementById('dtatblDisBudget'), ajxData)
  //
