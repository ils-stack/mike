  ...
  <section class="mb-4">
    <div class="card">
      <div class="card-header py-3">
        <h5 class="mb-0 text-center"><strong>Current Budget</strong></h5>
      </div>
      <div class="card-body" style = "min-height:800px;">
        ...
        <form class="row g-3 needs-validation" novalidate name = "users_data" method = "post" action = "/budget/update-budgets">
        @csrf
          @include('inc.current_budget_grid')
        ...
        <form class="row g-3 needs-validation" novalidate name = "users_data" method = "post" action = "/budget/update-expenses">
        @csrf
          @include('inc.current_expense_grid')
          <div class="col-12" align = "right">
